...
def create_frame(parent):
    ...
    entry_matricule=tk.Entry(formulaire,width=15)
    entry_matricule.place(relx=0.25,rely=0.40)
    element_matricule=entry_matricule.get()
